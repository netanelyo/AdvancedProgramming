...
private:
	...
	* 
	* @param xCoord - the X coordinate of the current attack
	* @param yCoord - the Y coordinate of the current attack
	* @return
	...
	* @param canPassTurn - a boolean representing if the next turn can be passed to the other playe
	*/
